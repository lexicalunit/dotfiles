...
gifsicle, git, git-flow, git-review, git-secrets, giter8, glib, gmp, gmp4, 
gnu-sed, gnu-tar, gnupg, gnutls, gradle, hub, icu4c, id3lib, id3v2, 
imagemagick@6, isl, jasper, jbig2dec, jez/formulae/pandoc-sidenote, jhead, jo, 
jpeg, jq, kafkacat, lame, libassuan, libevent, libffi, libgcrypt, libgpg-error, 
libgphoto2, libicns, libksba, libmpc, libpng, librdkafka, libssh2, libtasn1, 
libtiff, libtool, libunistring, libusb, libusb-compat, libvo-aacenc, libyaml, 
...
cursor-indicator, docblockr, event-watch, file-icons, flatwhite-syntax, 
force-tab, format-shell, git-blame, highlight-selected, indent-guide-improved, 
intentions, isotope-light-ui, isotope-ui, language-applescript, 
language-atom-notes, language-babel, language-cmake, language-diff, 
language-docker, language-groovy, language-latex, language-protobuf, 
...
sort-lines, standard-formatter, tab-control, tabs-to-spaces, 
...
Conda Packages: appnope, asn1crypto, astroid, babel, backports, 
backports.functools_lru_cache, backports.shutil_get_terminal_size, 
backports_abc, beautifulsoup4, bokeh, boto, ca-certificates, certifi, cffi, 
chardet, click, cloudpickle, conda, conda-env, configparser, cryptography, 
curl, dask, dask-core, decorator, distributed, docutils, enum34, flake8, flask, 
functools32, futures, get_terminal_size, gevent, greenlet, heapdict, idna, 
intel-openmp, ipaddress, ipython, ipython_genutils, itsdangerous, jedi, jinja2, 
jsonschema, lazy-object-proxy, libcxx, libcxxabi, libedit, libffi, libgfortran, 
libssh2, locket, markupsafe, mccabe, mkl, msgpack-python, ncurses, nose, numpy, 
openssl, p, pandas, parso, partd, pathlib2, pep8, pexpect, pickleshare, pip, 
prompt_toolkit, psutil, ptyprocess, pycodestyle, pycosat, pycparser, pycrypto, 
pycurl, pyflakes, pygments, pylint, pymongo, pyopenssl, pyparsing, pysocks, 
pytables, pytest, python-dateutil, python.app, pytz, pyyaml, readline, 
requests, ruamel_yaml, scandir, scikit-learn, scipy, setuptools, simplegeneric, 
singledispatch, six, sortedcontainers, sqlalchemy, sqlite, ssl_match_hostname, 
tblib, tk, toolz, tornado, traitlets, urllib3, wcwidth, werkzeug, wheel, wrapt, 
xz, yaml, zict, zlib
