...
Atom Packages: MagicPython, activate-power-mode, api-workbench, atom-isort, 
atom-pair, autocomplete-go, autocomplete-python, autoupdate-packages, 
builder-go, column-select, cursor-indicator, event-watch, file-icons, 
git-time-machine, go-config, go-get, go-plus, gofmt, gometalinter-linter, 
gorename, gruvbox, highlight-selected, indent-guide-improved, isotope-light-ui, 
isotope-ui, language-applescript, language-cmake, language-diff, 
...
native-ui, navigator-godef, next-occurrence, nvatom, pretty-json, python-yapf, 
