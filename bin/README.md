...
coreutils, cppunit, dmd, docker, docker-compose, docker-machine, doxygen, faac, 
...
sdl2, sdl2_image, shellcheck, sloccount, spark, sqlite, sqliteodbc, storm, 
swig, tree, unixodbc, unrar, vramsteg, watch, webp, wget, x264, xvid, xz, 
...
Atom Packages: MagicPython, api-workbench, atom-pair, autocomplete-python, 
...
language-json, language-latex, language-restructuredtext, language-rust, 
...
linter-shellcheck, linter-tidy, linter-write-good, merge-conflicts, minimap, 
...
native-ui, next-occurrence, nvatom, pretty-json, python-isort, python-yapf, 
...
appnope, appscript, argcomplete, astropy, babel, beautifulsoup4, bitarray, 
blaze-core, bokeh, boto, bottleneck, cffi, clyent, colorama, conda, 
conda-build, conda-env, configobj, cryptography, curl, cycler, cython, cytoolz, 
datashape, decorator, docutils, dynd-python, et_xmlfile, fastcache, flake8, 
flask, freetype, futures, greenlet, h5py, hdf5, idna, ipykernel, ipython, 
ipython-notebook, ipython-qtconsole, ipython_genutils, ipywidgets, 
itsdangerous, jbig, jdcal, jedi, jinja2, jpeg, jsonschema, jupyter, 
jupyter_client, jupyter_console, jupyter_core, launcher, libdynd, libpng, 
libtiff, libxml2, libxslt, llvmlite, lxml, markupsafe, matplotlib, mccabe, 
mistune, mkl, mkl-service, multipledispatch, nbconvert, nbformat, networkx, 
nltk, node-webkit, nose, notebook, numba, numexpr, numpy, odo, openpyxl, 
openssl, pandas, path.py, patsy, pep8, pexpect, pickleshare, pillow, pip, ply, 
psutil, ptyprocess, py, pyasn1, pycosat, pycparser, pycrypto, pycurl, pyflakes, 
pygments, pymongo, pyopenssl, pyparsing, pyqt, pytables, pytest, python, 
python-dateutil, python.app, pytz, pyyaml, pyzmq, qt, qtconsole, readline, 
redis, redis-py, requests, rope, scikit-image, scikit-learn, scipy, setuptools, 
simplegeneric, sip, six, snowballstemmer, sockjs-tornado, sphinx, 
