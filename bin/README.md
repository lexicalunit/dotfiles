...
jasper, jbig2dec, jhead, jo, jpeg, jq, kafkacat, lame, libassuan, libevent, 
libffi, libgcrypt, libgpg-error, libgphoto2, libicns, libksba, libmpc, libpng, 
...
maven, md5sha1sum, memcached, mongodb, mpfr, mysql, ncftp, net-snmp, nettle, 
nginx, no-more-secrets, node, npth, onepass, oniguruma, openssl, ossp-uuid, 
p11-kit, pandoc, pcre, percona-toolkit, pidof, pinentry, pkg-config, plotutils, 
pngquant, postgresql, protobuf, pyenv, pyenv-virtualenv, 
...
decaffeinate, dockerlint, eslint, js-beautify, json-stable-stringify, moment, 
