...
highlight-selected, indent-guide-improved, isotope-light-ui, isotope-ui, 
...
linter-docker, linter-erb, linter-flake8, linter-jsonlint, linter-just-say-no, 
linter-raml, linter-shellcheck, linter-tidy, linter-write-good, 
merge-conflicts, minimap, minimap-codeglance, minimap-find-and-replace, 
minimap-git-diff, minimap-highlight-selected, minimap-selection, monokai, 
multi-wrap-guide, native-ui, navigator-godef, next-occurrence, nvatom, 
pretty-json, python-isort, python-yapf, rainbow-selection, raml, 
...
tabs-to-spaces, tester-go, todo-show, toggle-quotes, trailing-spaces
