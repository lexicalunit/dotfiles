...
pyenv-virtualenvwrapper, rabbitmq, readline, redis, ripgrep, rust, s3cmd, 
sane-backends, sbt, scala, scons, sdl2, sdl2_image, shellcheck, sloccount, 
spark, sqlite, sqliteodbc, storm, swig, tree, unixodbc, unrar, v8, vegeta, 
vramsteg, watch, wdiff, webp, wget, wxmac, x264, xvid, xz, yajl, yaml-cpp, 
