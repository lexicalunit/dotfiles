...
addressable, airbrussh, archive-tar-minitar, arr-pm, backports, bigdecimal, 
blankslate, bson, bson_ext, builder, bundler, bundler-unload, cabin, cap_gun, 
capistrano, capistrano-harrow, capistrano-stats, celluloid, 
celluloid-essentials, celluloid-extras, celluloid-fsm, celluloid-pool, 
celluloid-supervision, childprocess, claide, clamp, classifier-reborn, 
...
colorize, commander, corefines, cuba, did_you_mean, dotenv, erector, erubis, 
escape, execjs, executable-hooks, faraday, faraday_middleware, fast-stemmer, 
ffi, fourflusher, fpm, fuzzy_match, gem-wrappers, globalid, highline, hitimes, 
i18n, io-console, io-like, jekyll, jekyll-coffeescript, jekyll-gist, 
...
net-telnet, netrc, nokogiri, octokit, open4, paint, parslet, polyglot, 
...
redcarpet, rouge, rspec-logsplit, ruby-xz, ruby_dep, rubygems-bundler, rvm, 
safe_yaml, sass, sawyer, shotgun, sshkit, terminal-table, test-unit, 
thread_safe, timers, toml, treetop, trollop, tzinfo, xcodeproj, yajl-ruby
